...
export default function JobCard({jobDetails}) {
  ...
  <div className='xl:w-[23%] lg:w-[31%] md:w-[40%] sm:w-[70%] shadow-md hover:scale-105 hover:shadow-lg m-2 p-6 rounded-xl'>
    <div className='flex'>
      <img src='https://upload.wikimedia.org/wikipedia/commons/f/f4/Weekday_Logo.jpg' className='rounded-full w-12 h-12 object-contain border p-1 aspect-square'/>
      <div className='ml-4 flex flex-col gap-1'>
        <h3 className='text-[13px] font-semibold text-gray-500'>Weekday</h3>
        <p className='text-[14px] capitalize'>{jobDetails.jobRole}</p>
    ...
    <div className='mt-6'>
      ...
      <p className='job-description'>{jobDetails.jobDetailsFromCompany.slice(0,300)}</p>
